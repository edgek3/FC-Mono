...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        dataset = datasets.KITTIRAWDataset(opt.data_path, filenames,
                                           ...
                                           [0], 4, img_ext=img_ext, is_train=False)
        ...
        depth_decoder.load_state_dict(state_dict, strict=False)  
        ...
        with torch.no_grad():
            for data in tqdm(dataloader):
                ...
                flops_e, params_e = profile(encoder, inputs=(input_color, ), verbose=False)
                flops_d, params_d = profile(depth_decoder, inputs=(encoder(input_color), ), verbose=False)
            ...
            print("flops_e, params_e") 
            print(flops_e, params_e)    
            print("flops_d, params_d") 
            print(flops_d, params_d)     
